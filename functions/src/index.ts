...
// ---------------------------------------------------------------------------
// Sync custom vocabulary example sentences <-> customSentences (per-user, bi-directional)
// ---------------------------------------------------------------------------

function customMirrorSentenceIdFor(wordId: string, exampleId: string): string {
